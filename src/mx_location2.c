...
int mx_location2(SDL_Renderer *renderer) {
    ...
    SDL_Event event;
    bool loc_run = true;
    SDL_Texture* location2 = IMG_LoadTexture(renderer, "resource/images/location2.png");
    SDL_Texture* platform_location2 = IMG_LoadTexture(renderer, "resource/images/platform_location2.png");
    ...
    SDL_Texture* hero_run = IMG_LoadTexture(renderer, "resource/images/run_knight.png");
    SDL_Texture* hero_block = IMG_LoadTexture(renderer, "resource/images/block_knight.png");
    SDL_Texture* hero_attack_img = IMG_LoadTexture(renderer, "resource/images/attack_knight.png");
    SDL_Texture* enemy_stand_img = IMG_LoadTexture(renderer, "resource/images/k_stay.png");
    SDL_Texture* enemy_run_img = IMG_LoadTexture(renderer, "resource/images/k_run.png");
    SDL_Texture* enemy_attack_img = IMG_LoadTexture(renderer, "resource/images/k_attack.png");
    SDL_Texture* stay_portal = IMG_LoadTexture(renderer, "resource/images/stay_portal.png");

    Mix_Music *mainSound = Mix_LoadMUS("./resource/sounds/location2/music1.mp3"); 
    ...
    while (loc_run) {
        ...
        SDL_RenderCopy(renderer, location2, NULL, NULL);
        SDL_RenderCopy(renderer, platform_location2, NULL, NULL);
